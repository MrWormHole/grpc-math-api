...
var file_proto_math_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x32, 0xbb, 0x01, 0x0a, 0x0b, 0x4d, 0x61, 0x74, 0x68, 0x53, 0x65, 0x72,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x09, 0x53, 0x75, 0x62, 0x73, 0x74, 0x72, 0x61, 0x63,
...
var file_proto_math_proto_depIdxs = []int32{
	...
	0, // 2: proto.MathService.Divide:input_type -> proto.Request
	0, // 3: proto.MathService.Substract:input_type -> proto.Request
	1, // 4: proto.MathService.Add:output_type -> proto.Response
	1, // 5: proto.MathService.Multiply:output_type -> proto.Response
	1, // 6: proto.MathService.Divide:output_type -> proto.Response
	1, // 7: proto.MathService.Substract:output_type -> proto.Response
...
func (c *mathServiceClient) Substract(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.MathService/Substract", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMathServiceServer) Substract(context.Context, *Request) (*Response, error) {
...
func _MathService_Substract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.MathService/Substract",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MathServiceServer).Substract(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
